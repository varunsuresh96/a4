...
class FoodsTableSeeder extends Seeder
{
    ...
    public function run()
    {
      $foods = array(array('Egg boiled',80),array('Egg Fried',110),array('Bread slice',45),array('Chapati',60),array('Puri',75),array('Paratha',150),
                     ...
                     array('Hamburger',250),array('Steak and Salad',300),array('Spaghetti & meat/sauce',450),array('Fried chicken',200),
                     array('Chinese noodles',450),array('Chinese fried rice',450),array('Pizza',400));
